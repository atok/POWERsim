...
public class MobileDevice extends BaseDevice {

	public MobileDevice(ActorRef house) {
		super(house);
		// TODO Auto-generated constructor stub
	}

    private double powerUsage = 70; // [Watt]
    private int cookTimeBase = 3*60*60; // [second]
    private int cookBoilTimeBonus = 60*60;
    ...
    protected void onTime(ClockActor.TimeSignal t) {
        if (isOn) {
            ...
            if(logOn){
                ...
                log.warning("MobileDevice is " + (isOn ? "ON" : "OFF"));
            }
        }
    }
